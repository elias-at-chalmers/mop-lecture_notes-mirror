...
Pinnarna PD14 och PD15 skall ställas in som ingångar med pull-down motstånd. Visa hur
...
Visa hur AFIO konfigureras så att PD14 och PD15 kopplas till EXTI-modulen i CH32V307.
...
Visa hur EXTI och PFIC konfigureras så att avbrott genereras på både positiv och negativ
...
Implementera avbrottshanteraren `void at_irq(void)` så att saxlyften kontrolleras som
beskrivet ovan. (3p)
...
Nedanstående assemblyfil är given. Visa hur avbrottsvektorn för `at_irq` initieras i
...
För att spara pengar skulle man vilja att signalerna från UP och DOWN knappen gick över en
