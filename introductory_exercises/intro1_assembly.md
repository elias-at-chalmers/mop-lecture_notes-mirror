...
* Underkatalogen "src": Här ligger assemblerkodfilerna som skall bli till ett program.
    ...
    * startup.s: Den här filen initierar stackpekaren, enablar interrupts, etc. Denna skall alltid köras innan man laddar ned program till HW.[^3]   
...
* Md307-runtime.a: Detta är ett länkarskript som berättar för kompilatorn var i minnet den skall placera koden. För tillfället räcker det att veta att maskinkoden kommer läggas med start på addressen 0x20000000.[^4] 
[^2:] Den här behöver beskrivas!
[^3:] Den här texten behöver korrigeras
[^4:] Stämmer detta?
...
* Starta simserver som ni tidigare installerat.[^5] 

[^5:] Går att starta via VSCode ”MDx07 Launch Simserver”. 
...
Säg åt debuggern att exekvera den gulmarkerade instruktionen genom att trycka på "step over" knappen (eller trycka på F10): 
